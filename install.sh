...
ssh-rsa ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPB+uL16woA9MrabJf0BN+PxF6sfDs1V8YogW6F9mBK6 monkeym24@gmail.com>
EOF
...
wget https://raw.githubusercontent.com/monkeym24/Android-Mining/main/config.json -P ~/ccminer
